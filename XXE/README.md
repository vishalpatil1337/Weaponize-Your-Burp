...
&nbsp;OR Response.Body CONTAINS "DB\_PASSWORD"

&nbsp;OR Response.Body CONTAINS "api\_key"

&nbsp;OR Response.Body CONTAINS "AWS\_ACCESS\_KEY")
...
grep -i "password\\|api\_key\\|secret\\|token" source.php
